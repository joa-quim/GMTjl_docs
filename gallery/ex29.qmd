...
well in Cartesian coordinates hence the chosen approach. We use [greenspline] to produce
...
remote data set we can use to demonstrate spherical surface gridding. Since [greenspline]
