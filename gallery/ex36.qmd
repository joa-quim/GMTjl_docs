...
The next script produces the plot in Figure. Here we demonstrate how [sphinterpolate]
...
of data we recommend [sphinterpolate] while for small data sets (such as this one, actually)
you have more flexibility with [greenspline].
