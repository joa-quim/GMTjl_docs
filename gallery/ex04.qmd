...
in our first article in EOS Trans. AGU (8 October 1991). Using [grdview] one can choose
...
grid in that direction though the [grdgradient] program. We choose to use the -Qc option in
[grdview] to achieve a high degree of smoothness. Here, we select 100 dpi since that will be
