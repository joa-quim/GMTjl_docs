...
additional work. Also, note that the projection is only implemented in [coast] and
[grdimage]. We hope to refine this further and extend the availability of the full
