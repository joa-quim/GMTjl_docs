...
In this example we show how the module [plot] can be used to create a network of lines based
...
to each airport is identified as spherical Voronoi cells by [sphtriangulate] and filled with
