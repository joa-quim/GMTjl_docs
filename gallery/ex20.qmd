...
GMT plotting programs [plot] and [plot3]. Here we demonstrate one approach that
...
volcano symbol and [plot]. We do something similar with the bulls eye symbols. Without the
