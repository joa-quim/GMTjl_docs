...
corner of region. In our case we choose (160, 20) and (220, 30) as the corners. We twice use [grdimage] to make the illustration:
...
for the two map panels. We use [makecpt] to generate a linear color palette file for the geoid
...
legend to the right of the image with [colorbar]. We repeat these steps for the Geosat geoid grid.
Again, the labeling of the two plots with a) and b) is automatically done by [subplot].
