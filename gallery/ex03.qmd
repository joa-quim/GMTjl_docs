...
In this example we will show how to use the GMT programs [fitcircle], [project],
[sample1d], [spectrum1d], and [plot]. Suppose you have (lon, lat, gravity)
...
[fitcircle] to find this great circle and choose the L2 estimates of best pole. We project
the data using [project] to find out what their ranges are in the projected coordinate.
