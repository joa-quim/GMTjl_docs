...
GMT provides a way to illustrate 2-component vector fields using the [grdvector] utility. The two
...
in separate windows. A [text] call to place a header finishes the plot
