...
The script produces the plot in Figure. Here we demonstrate how [sphtriangulate] and
[sphdistance] are used to compute the Delauney and Voronoi information on a sphere, using
