...
when specifying map widths in the commands below. This initial setup is followed by two sequences of [coast]
[grdcontour], [grdcontour]. They differ in that the first is centered on the dateline,
