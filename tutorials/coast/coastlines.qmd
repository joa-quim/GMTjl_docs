...
GMT uses the {{< gmtref coast >}} utility to access a version of the GSHHG data specially formatted for GMT.
...
The `borders` option of {{< gmtref coast >}} specifies levels of political boundaries to plot and the
