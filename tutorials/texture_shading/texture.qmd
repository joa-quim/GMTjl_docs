...
For the time being it is a set of examples on how to use the {{< gmtref lelandshade >}} and dependent functions.
...
function {{< gmtref lelandshade >}} that aglutinates all of the above steps, plus some extra options, in a single function.
...
Consult the {{< gmtref lelandshade >}} manual to learn about them.
