...
![_Ah, nice ... but it's so dark that we can't really see much!_](/tutorials/Landsat8/b4raw.png){width=60% .center}
...
![.](/tutorials/Landsat8/b4hist.png){width=50% .center}
...
![.](/tutorials/Landsat8/b4stretched.png){width=65% .center}
...
![.](/tutorials/Landsat8/truecolor.png){width=65% .center}
