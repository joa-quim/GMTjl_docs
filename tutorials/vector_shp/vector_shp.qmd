...
information depending on the input data type. For [GMTdataset]s the _attribs_ keyword lets us limit the
...
We can access the data from that site using the _gadm_ function (see examples in [GADM]).
