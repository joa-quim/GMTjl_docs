...
Color images are made with {{< gmtref grdimage >}} which takes the usual common options and a color map.
...
cache dir. See this [`GMT tutorial`](http://docs.generic-mapping-tools.org/latest/tutorial/julia/session-4.html)
