...
- *locations="fname" or locations=array*\
   ...
   decorated lines. Optionally, passa a Mx2 array (or {{< gmtref GMTdataset type=gmttype >}}) with the symbols location. Symbols will
...
- *color=color*\
   ...
   The *color* is a [Setting color] element.
- *const_label="xx"*\
