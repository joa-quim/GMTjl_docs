...
Color can be selected in several different ways. One of the is to create color maps with the {{< gmtref makecpt >}} and
{{< gmtref grd2cpt >}} modules. This is the method we use to colorize images, sets of points, etc.
