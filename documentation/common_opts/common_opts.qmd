...
far this option is to be used mainly when creating {{< gmtref subplot >}}'s
...
controlled by the GMT default setting [FORMAT\_GEO\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_GEO_MAP)).
...
- **:month** or **:O** (month, plot using [FORMAT\_DATE\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_DATE_MAP))
- **:month2** or **:o** (month, plot with 2 digits)
- **:ISOweek** or **:U** (ISO week, plot using [FORMAT\_DATE\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_DATE_MAP))
- **:ISOweek2** or **:u** (ISO week, plot using 2 digits)
- **Gregorian_week** or **:r** (Gregorian week, 7-day stride from start of week [TIME\_WEEK\_START](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-TIME_WEEK_START))
- **:ISOweekday** or **:K** (ISO weekday, plot name of day)
- **:date** or **:D** (date, plot using [FORMAT\_DATE\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_DATE_MAP))
- **:day_date** or **:d** (day, plot day of month 0-31 or year 1-366, via [FORMAT\_DATE\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_DATE_MAP))
- **:day_week** or **:R** (day, same as **d**, aligned with [TIME\_WEEK\_START](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-TIME_WEEK_START))
- **:hour**    or **:H** (hour, plot using [FORMAT\_CLOCK\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_CLOCK_MAP))
- **:hour2**   or **:h** (hour, plot with 2 digits)
- **:minute**  or **:M** (minute, plot using [FORMAT\_CLOCK\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_CLOCK_MAP))
- **:minute2** or **:m** (minute, plot with 2 digits)
- **:second**  or **:S** (second, plot using [FORMAT\_CLOCK\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_CLOCK_MAP))
- **:second2** or **:s** (second, plot with 2 digits).


Note for geographic axes **m** and **s** instead mean arc minutes and arc seconds.
All entities that are language-specific are under control by [GMT\_LANGUAGE](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-GMT_LANGUAGE). 
...
[MAP\_ANNOT\_MIN\_ANGLE](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_ANNOT_MIN_ANGLE),
[MAP\_ANNOT\_MIN\_SPACING](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_ANNOT_MIN_SPACING),
[FONT\_ANNOT\_PRIMARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FONT_ANNOT_PRIMARY),
[FONT\_ANNOT\_SECONDARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FONT_ANNOT_SECONDARY),
[MAP\_ANNOT\_OFFSET\_PRIMARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_ANNOT_OFFSET_PRIMARY),
[MAP\_ANNOT\_OFFSET\_SECONDARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_ANNOT_OFFSET_SECONDARY),
[MAP\_ANNOT\_ORTHO](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_ANNOT_ORTHO),
[MAP\_FRAME\_AXES](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_FRAME_AXES),
[MAP\_DEFAULT\_PEN](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_DEFAULT_PEN),
[MAP\_FRAME\_TYPE](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_FRAME_TYPE),
[FORMAT\_GEO\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_GEO_MAP),
[MAP\_FRAME\_PEN](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_FRAME_PEN),
[MAP\_FRAME\_WIDTH](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_FRAME_WIDTH),
[MAP\_GRID\_CROSS\_SIZE\_PRIMARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_GRID_CROSS_SIZE_PRIMARY),
[MAP\_GRID\_PEN\_PRIMARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_GRID_PEN_PRIMARY),
[MAP\_GRID\_CROSS\_SIZE\_SECONDARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_GRID_CROSS_SIZE_SECONDARY),
[MAP\_GRID\_PEN\_SECONDARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_GRID_PEN_SECONDARY),
[FONT\_TITLE](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FONT_TITLE),
[FONT\_LABEL](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FONT_LABEL),
[MAP\_LINE\_STEP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_LINE_STEP),
[MAP\_ANNOT\_OBLIQUE](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_ANNOT_OBLIQUE),
[FORMAT\_CLOCK\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_CLOCK_MAP),
[FORMAT\_DATE\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_DATE_MAP),
[FORMAT\_TIME\_PRIMARY\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_TIME_PRIMARY_MAP),
[FORMAT\_TIME\_SECONDARY\_MAP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_TIME_SECONDARY_MAP),
[GMT\_LANGUAGE](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-GMT_LANGUAGE),
[TIME\_WEEK\_START](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-TIME_WEEK_START),
[MAP\_TICK\_LENGTH\_PRIMARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_TICK_LENGTH_PRIMARY),
and [MAP\_TICK\_PEN\_PRIMARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_TICK_PEN_PRIMARY)
...
[GMT\_INTERPOLANT](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-GMT_INTERPOLANT),
[PROJ\_SCALE\_FACTOR](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-PROJ_SCALE_FACTOR), and
[PROJ\_LENGTH\_UNIT](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-PROJ_LENGTH_UNIT);
...
- **U | timestamp | time_stamp** : *timestamp=(just="code", pos=(dx,dy), label="label", com=true)*
   ...
   *label*, or **c** (which will plot the command string.). The GMT
   parameters [MAP_LOGO](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_LOGO), [MAP_LOGO_POS](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_LOGO_POS), and
   [FORMAT_TIME_STAMP](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FORMAT_TIME_STAMP) can affect the appearance; see the
...
- **j | spheric | spheric_dist** : -- *spheric=:e|:f|:g*\
    Determine how spherical distances are calculated in modules that support this. By default (**spheric=:g**) we perform great circle distance calculations and parameters such as distance increments or radii will be compared against calculated great circle distances. To simplify and speed up calculations you can select Flat Earth mode (**spheric=:f**) which gives an approximate and fast result. Alternatively, you can select ellipsoidal (**spheric=:e**) or geodesic mode for the highest precision (and slowest calculation time). All spherical distance calculations depends on the current ellipsoid ([PROJ_ELLIPSOID](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-PROJ_ELLIPSOID)), the definition of the mean radius ([PROJ_MEAN_RADIUS](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-PROJ_MEAN_RADIUS)), and the specification of latitude type ([PROJ_AUX_LATITUDE](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-PROJ_AUX_LATITUDE)). Geodesic distance calculations is also controlled by method ([PROJ_GEODESIC](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-PROJ_GEODESIC)).
