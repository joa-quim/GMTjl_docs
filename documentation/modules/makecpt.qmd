...
the master CPT. When there is no [COLOR_MODEL](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-COLOR_MODEL) entry in the master CPT, the [COLOR_MODEL](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-COLOR_MODEL) specified in the `gmt.conf`
