...
- **G** or **fill** : -- *fill=fill*\
    Sets color or shade for vector interiors (see {{< gmtref "Fill color/pattern" >}}) [Default is no fill].
...
- **Q** or **vec** or **vector** or **arrow** : -- *vector=parameters*\
    ...
    See {{< gmtref "Vector Attributes" >}} for specifying additional attributes.
