...
the `COLOR_MODEL` specified in the `gmt.conf` (see {{< gmtref gmtset >}}) file or on the command line will be used.
...
{{< include ../common_opts/create_cpt.md >}}
...
{{< include ../common_opts/explain_transparency.md >}}
