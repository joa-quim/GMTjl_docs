...
- **D** or **inc** or **increment** : -- *inc=increment*\
    *increment* is used when series is NOT equidistantly sampled. Then *increment* will be the
    ...
    Alternatively, resample data with {{< gmtref sample1d >}}.
...
{{< include ../common_opts/opt_range.md >}}
...
{{< gmtref sample1d >}}. To find the median depth in a 50 km window every 25 km along the track of
