...
- **D** or **density** : -- *density=?* **|** *density=rhogrid*\
    ...
    a co-registered grid, *rhogrid*, either in the form of a file name or a {{< gmtref GMTgrid type=gmttype >}} objec, with density
...
- **I** or **admitt** : -- *admitt=(wavelengths=true, km=true, coherence=true, tadmitt=true, elastic=true)*\
    ...
    coherence and rturn it in a {{< gmtref GMTdataset type=gmttype >}} (**outgrid** ignored if set). This grid
...
{{< include ../common_opts/explain_fft.md >}}
...
onto a rectangular coordinate system using {{< gmtref grdproject >}}.
...
{{< gmtref parkergrav >}}, {{< gmtref grdfft >}}, {{< gmtref grdproject >}}
