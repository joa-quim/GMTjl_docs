...
- **H** or **mag_params** : -- *mag_params=f_dec/f_dip/m_int/m_dec/m_dip* **|** *mag_params="magfile"|maggrid* **|**  *mag_params="x|X|y|Y|z|Z|h|H|t|T|f|F" **|** *mag_params="+i|+n"*\
    ...
    OR for a grid mode
      ...
      - *maggrid*, a {{< gmtref GMTgrid type=gmttype >}}  grid, or *magfile*, where *magfile* is the name of the magnetic intensity file.
...
#| output: asis
using GMT
GMT.doc_source_links("grdgravmag3d")
```
...
{{< gmtref gravmag3d >}}, {{< gmtref gravprism >}}, {{< gmtref talwani2d >}}, {{< gmtref talwani3d >}}
