...
Options include full circle and half circle plots. The outline of the windrose is drawn with the same color as [MAP_DEFAULT_PEN](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_DEFAULT_PEN).
...
- **F** or **no_scale** : -- *no_scale=true*\
    ...
    is used. We use [MAP_TICK_PEN_PRIMARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-MAP_TICK_PEN_PRIMARY) to draw the scale and label it with [FONT_ANNOT_PRIMARY](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-FONT_ANNOT_PRIMARY).
...
- **L** or **labels** : -- *labels=true* **|** *labels=(wlabel,elabel,slabel,nlabel)*\
    ...
    Use **labels=true** to disable all four labels. Note that the [GMT_LANGUAGE](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-GMT_LANGUAGE) setting will affect the words used.
