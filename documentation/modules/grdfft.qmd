...
*ingrid*
:   2-D binary grid file to be operated on. Can be a file name, a {{< gmtref GMTgrid type=gmttype >}} object, or a Matrix.
...
- **E** or **radial\_power** : -- *radial_power=true* **|** *radial_power=:r* **|** *radial\_power=(dir=:x, modifiers...)* **|** *radial\_power="r+w+n"*\
...
#| output: asis
using GMT
GMT.doc_source_links("grdfft")
```

## See Also

{{< gmtref grdfilter >}}, {{< gmtref grdproject >}}