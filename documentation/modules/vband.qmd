...
- **fill** or **color**\
   ...
   a vector or a tuple of colors. See {{< gmtref "Setting color" >}} for extend color selection (including color
...
{{< gmtref vlines >}}, {{< gmtref hlines >}}
```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("vband")
```
