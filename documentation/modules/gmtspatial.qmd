...
*table*
:   One data table or file. Can be a file name, a {{< gmtref GMTdataset type=gmttype >}} object, or a Matrix.
...
#| output: asis
using GMT
GMT.doc_source_links("gmtspatial")
```

## See Also

{{< gmtref gmtselect >}}, {{< gmtref gmtsimplify >}}, {{< gmtref mapproject >}}