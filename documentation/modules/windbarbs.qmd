...
- **G** or **fill** : -- *fill=fill*\
    Sets color or shade for wind barb interiors (see {{< gmtref "Fill color/pattern" >}}) [Default is no fill].
...
#| output: asis
using GMT
GMT.doc_source_links("windbarbs")
```

See Also
--------

{{< gmtref grdcontour >}}, {{< gmtref grdvector >}}
