...
{{< include ../common_opts/opt_Asteps.md >}}
...
- **S** or **search_radius** : -- *search_radius=rad* **|** *search_radius=(xlim,ylim)*\
    ...
    unit (see [Units]). If *radius* is given as **z** then we instead read individual
...
yield artifacts in your map. We recommend you use {{< gmtref grdimage >}} **interp=:n** to instead use
