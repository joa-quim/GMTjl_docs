...
See full GMT docs at [`pswiggle`](http://docs.generic-mapping-tools.org/latest/wiggle.html)
...
```julia
# 2 methods for generic function "wiggle" from GMT:
 [1] wiggle(cmd0::String; kw...)
     @ C:\Users\j\.julia\packages\GMT\Td19G\src\pswiggle.jl:60
 [2] wiggle(arg1; kw...)
     @ C:\Users\j\.julia\packages\GMT\Td19G\src\pswiggle.jl:61
```
