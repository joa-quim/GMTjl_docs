...
data extraction and {{< gmtref wiggle >}} plotting, and can also be used to
...
**N** or **multifile** or **multi** : -- *multifile=true* **|** *multifile="template"*\
    Write each segment to a separate output file. Default returns data in a {{< gmtref GMTdataset type=gmttype >}}. Optionally
...
#| output: asis
using GMT
GMT.doc_source_links("gmtsplit")
```

\1

{{< gmtref filter1d >}}, {{< gmtref wiggle >}}
