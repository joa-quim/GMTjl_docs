...
*table*
    3 [or 4, see **weights**] column data from file or {{< gmtref GMTdataset type=gmttype >}} holding (*x,y,z*[,*w*]) data values.
...
- **S** or **search_radius** : -- *search_radius=rad*\
    ...
    close to a node. Append the distance unit (see [Units]).
...
#| output: asis
using GMT
GMT.doc_source_links("nearneighbor")
```
