...
The second method expects a {{< gmtref GMTgrid type=gmttype >}} or an {{< gmtref GMTimage type=gmttype >}} as first argument and
...
(or inside) of the land areas. See also the {{< gmtref mask >}} module that has also a method with a
...
and thus may yield artifacts in your map. We recommend you use {{< gmtref grdimage >}}
...
#| output: asis
using GMT
GMT.doc_source_links("grdlandmask")
```

\1

{{< gmtref grdclip >}}, {{< gmtref mask >}}, {{< gmtref clip >}}, {{< gmtref coast >}}
