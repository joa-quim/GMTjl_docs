...
- *table*\
    The name of one or more data files (or a {{< gmtref GMTdataset type=gmttype >}} or Matrix) holding the x, w data points. If no input is given then standard input is read.
...
#| output: asis
using GMT
GMT.doc_source_links("greenspline")
```

## See Also

{{< gmtref blockmean >}}, {{< gmtref blockmedian >}}, {{< gmtref blockmode >}}, {{< gmtref nearneighbor >}}, {{< gmtref sample1d >}}, {{< gmtref surface >}}, {{< gmtref triangulate >}}