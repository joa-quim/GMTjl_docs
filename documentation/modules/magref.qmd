...
- **A** or **adjust** : -- *input_params=(alt|altitude=true, onetime=true, yeardec=true)*\
    ...
    **onetime=true** to set a fixed *time* that should apply to all data records [Default expects *time* to be in
    ...
    [TIME_EPOCH](https://docs.generic-mapping-tools.org/dev/gmt.conf.html#term-[TIME_EPOCH](https://docs.generic-mapping-tools.org/latest/gmt.conf.html#term-TIME_EPOCH))].\
...
1×3 {{< gmtref GMTdataset type=gmttype >}}{Float64, 2}
 Row │   col.1    col.2    col.3
─────┼───────────────────────────
