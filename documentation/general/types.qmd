# The GMT.jl types (important) {#sec-gmtjl-types}

## Grid type {#sec-grid-type}

The {{< gmtref GMTgrid type=gmttype >}} type is how grids, (geo)referenced or not, comunicate in/out with the GMT library.
...
## Postscript type {#sec-postscript-type}
...
## Face-Vertices type {#sec-fv-type}
