...
GMTdataset.html) type implies that this was computed with the {{< gmtref linearfitxy >}} function,
...
{{< gmtref plotlinefit >}}, {{< gmtref linearfitxy >}}, {{< gmtref plot >}}

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("ablines")
```
