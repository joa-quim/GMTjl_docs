...
Create a projected graticule {{< gmtref GMTdataset type=gmttype >}} with meridians and parallels at `width` intervals.

- `D`: A {{< gmtref GMTdataset type=gmttype >}} (or vector of them) holding the projection info. Instead of {{< gmtref GMTdataset type=gmttype >}} type, this
...
{{< gmtref coastlinesproj >}}, [plotgrid!], {{< gmtref worldrectangular >}}, {{< gmtref worldrectgrid >}}, {{< gmtref worldrectcoast >}},
...
#| output: asis
using GMT
GMT.doc_source_links("graticules")
```
