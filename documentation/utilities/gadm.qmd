...
Returns a {{< gmtref GMTdataset type=gmttype >}} for the requested country, or country subregion(s)
...
- `children_raw`: When true, function returns two variables -> parent, children, where children is a GDAL
  ...
  the states/provinces. If `children` we return a Vector of {{< gmtref GMTdataset type=gmttype >}} with the polygons. If `children_raw`
