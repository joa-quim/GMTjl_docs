...
A {{< gmtref GMTgrid type=gmttype >}} cube object, or `nothing` if the `save` option is used.


See Also
--------

{{< gmtref cubeplot >}}, {{< gmtref slicecube >}}, {{< gmtref xyzw2cube >}}

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("stackgrids")
```
