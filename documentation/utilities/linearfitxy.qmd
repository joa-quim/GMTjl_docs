...
The results are added as new columns of a {{< gmtref GMTdataset type=gmttype >}} structure when they are vectors (`σX σY r`)
...
{{< gmtref plotlinefit >}}, {{< gmtref plot >}}

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("linearfitxy")
```
