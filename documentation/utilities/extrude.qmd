...
### Args
- `shape`: The shape to extrude. It can be a 2D polygon or a 3D polygon defined by a Mx2 or Mx3 matrix or a {{< gmtref GMTdataset type=gmttype >}}
...
And a much nicer example combining extrusion and painting top surface with {{< gmtref flatfv >}}.
...
{{< gmtref flatfv >}}, {{< gmtref fv2fv >}}, {{< gmtref loft >}}, {{< gmtref grid2tri >}}, {{< gmtref revolve >}}, {{< gmtref surf2fv >}}
```{julia}
#| echo: false
#| output: asis
using GMT
