...
{{< gmtref cube >}}, {{< gmtref cylinder >}}, {{< gmtref dodecahedron >}}, {{< gmtref icosahedron >}}, {{< gmtref octahedron >}}, {{< gmtref replicant >}}, {{< gmtref sphere >}}, {{< gmtref torus >}},  

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("tetrahedron")
```
