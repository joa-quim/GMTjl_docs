...
Change the alpha transparency of the {{< gmtref GMTimage type=gmttype >}} object `img`. If the image is indexed, one can either
...
[image_cpt!], {{< gmtref ind2rgb >}}

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("image_alpha!")
```
