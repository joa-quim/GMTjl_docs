...
Convert data table containing a cube into a {{< gmtref GMTgrid type=gmttype >}} cube. The input data must contain a completelly filled
...
A {{< gmtref GMTgrid type=gmttype >}} cube object.


See Also
--------

{{< gmtref cubeplot >}}, {{< gmtref slicecube >}}, {{< gmtref stackgrids >}}

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("xyzw2cube")
```
