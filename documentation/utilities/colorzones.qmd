...
- `shapes`: A vector of {{< gmtref GMTdataset type=gmttype >}} containing the polygons to be painted. This container will be changed
  in the sense that the `header` field of each polygon (a {{< gmtref GMTdataset type=gmttype >}}) will be appended with the fill
...
[rasterzones!], {{< gmtref gmtread >}}, {{< gmtref wmsinfo >}}, {{< gmtref wmsread >}}

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("colorzones!")
```
