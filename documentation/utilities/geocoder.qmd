...
Returns
-------
A {{< gmtref GMTdataset type=gmttype >}} with the longitude, latitude, and full attribute dictionary returned by the geocoder for
...
useful to use in the `mosaic` program. For that purpose, the returned BB is sored in the [GMTdatset](GMTdatset.html)
``ds_bbox`` field.
