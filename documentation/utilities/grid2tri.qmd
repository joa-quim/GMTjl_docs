...
### Args
- `G`: A {{< gmtref GMTgrid type=gmttype >}} object or a grid file name representing the surface to be triangulated.
...
### Returns
A vector of {{< gmtref GMTdataset type=gmttype >}} with the triangulated surface and vertical wall, or just the wall or the full closed body.
...
![](/assets/subduction.png){width="1000" .center}

See Also
--------

{{< gmtref extrude >}}, {{< gmtref flatfv >}}, {{< gmtref fv2fv >}}, {{< gmtref loft >}}, {{< gmtref revolve >}}, {{< gmtref surf2fv >}}
```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("grid2tri")
```
