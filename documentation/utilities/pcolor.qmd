...
- `kwargs`: This form of `pcolor` is in fact a wrap up of {{< gmtref plot >}} so any option of that module can be used here.
...
- `kwargs`: This form of `pcolor` is a wrap of {{< gmtref grdview >}} so any option of that module can be used here.
...
{{< gmtref grdview >}}, {{< gmtref plot >}}

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("pcolor")
```
