...
- `A`: is either a {{< gmtref GMTgrid type=gmttype >}}, {{< gmtref GMTimage type=gmttype >}}, Matrix{AbstractArray} or a file name.
  In later case the file is read with a call to {{< gmtref gmtread >}} that automatically decides how to read it
...
A {{< gmtref GMTgrid type=gmttype >}} if `A` is a {{< gmtref GMTgrid type=gmttype >}} of floats, a {{< gmtref GMTimage type=gmttype >}} if `A` is a {{< gmtref GMTimage type=gmttype >}} and
