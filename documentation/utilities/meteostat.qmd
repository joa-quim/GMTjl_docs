...
Download the Meteostat stations list and return it as a {{< gmtref GMTdataset type=gmttype >}}.
...
### Returns
A {{< gmtref GMTdataset type=gmttype >}} with the data from the closest station to the given coordinates.
