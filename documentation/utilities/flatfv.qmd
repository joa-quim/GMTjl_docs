...
### Args
- `I`: A {{< gmtref GMTimage type=gmttype >}} object or a file name of an image.
...
### Returns
A {{< gmtref GMTfv type=gmttype >}} FacesVertices object representing the flat 3D surface.
...
{{< gmtref extrude >}}, {{< gmtref fv2fv >}}, {{< gmtref loft >}}, {{< gmtref grid2tri >}}, {{< gmtref revolve >}}, {{< gmtref surf2fv >}}

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("flatfv")
```
