...
- `D`: A Vector of [GMTdadaset](GMTdadaset.html) defining the polygons.
...
{{< gmtref inpolygon >}}, {{< gmtref getbyattrib >}}, {{< gmtref plot >}}, {{< gmtref triplot >}}

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("inwhichpolygon")
```
