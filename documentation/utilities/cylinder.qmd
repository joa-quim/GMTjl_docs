...
{{< gmtref cube >}}, {{< gmtref dodecahedron >}}, {{< gmtref icosahedron >}}, {{< gmtref octahedron >}}, {{< gmtref replicant >}}, {{< gmtref sphere >}}, {{< gmtref tetrahedron >}}, {{< gmtref torus >}},  

```{julia}
#| echo: false
#| output: asis
using GMT
GMT.doc_source_links("cylinder")
```
