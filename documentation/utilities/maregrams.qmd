...
### Kwargs
- `list`: If equal to `true`, returns a {{< gmtref GMTdataset type=gmttype >}} with the list all available stations and their codes and coords.
...
### Returns
- `D`: {{< gmtref GMTdataset type=gmttype >}} with the maregrams data.
...
#| output: asis
using GMT
GMT.doc_source_links("maregrams")
```
