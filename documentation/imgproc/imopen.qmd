...
### Returns
A new {{< gmtref GMTimage type=gmttype >}} of the same type as `I` with the opening applied.
...
![](/assets/imopen_nocrash.png){width="600" .center}
...
#| output: asis
using GMT
GMT.doc_source_links("imopen")
```

### See Also

{{< gmtref imdilate >}}, {{< gmtref imerode >}}, {{< gmtref imclose >}}, {{< gmtref strel >}}
