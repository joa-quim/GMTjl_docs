...
### Returns
A new {{< gmtref GMTimage type=gmttype >}} of the same type as `I` with the morphological gradient applied.
...
#| output: asis
using GMT
GMT.doc_source_links("immorphgrad")
```

\1

{{< gmtref imdilate >}}, {{< gmtref imerode >}}
