...
Returns a binary {{< gmtref GMTimage type=gmttype >}} containing 1s where the function finds edges in the grayscale or binary image I and 0s elsewhere.
...
### Returns
- A new {{< gmtref GMTimage type=gmttype >}} grayscale image `I` with the edge detection, edges are brighter.
...
#| output: asis
using GMT
GMT.doc_source_links("imsobel")
```

\1

{{< gmtref imfill >}}, {{< gmtref bwskell >}}, {{< gmtref imerode >}}, {{< gmtref imfilter >}}
