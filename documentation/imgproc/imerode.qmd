...
### Returns
A new {{< gmtref GMTimage type=gmttype >}} of the same type as `I` with the erosion applied.
...
![](/assets/imerode_nocrash.png){width="600" .center}
...
#| output: asis
using GMT
GMT.doc_source_links("imerode")
```

### See Also

{{< gmtref imdilate >}}, {{< gmtref imopen >}}, {{< gmtref imclose >}}, {{< gmtref strel >}}
