...
### Returns
A new {{< gmtref GMTimage type=gmttype >}} of the same type as `I` with the tophat applied.
...
{{< gmtref imdilate >}}, {{< gmtref imerode >}}, {{< gmtref imopen >}}, {{< gmtref imbothat >}}
