...
### Returns
A new {{< gmtref GMTimage type=gmttype >}} of the same type as `I` with the bothat applied.
...
{{< gmtref imdilate >}}, {{< gmtref imerode >}}, {{< gmtref imopen >}}, {{< gmtref imtophat >}}
