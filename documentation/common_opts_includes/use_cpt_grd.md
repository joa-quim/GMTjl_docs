- **C** or **color** or **cmap** or **colorap** or **colorscale** : -- *color=cpt*\
   Where *cpt* is a *{{< gmtref GMTcpt type=gmttype >}}* type or a cpt file name (for *grd\_z* only). Alternatively, supply the name of
   ...
   *color="color1,color2 [,color3 ,...]"* or *color=((r1,g1,b1),(r2,g2,b2),...)* to build a linear continuous
   ...
   an HTML hexadecimal color (e.g. #aabbcc ) (see \[Setting color](../common_features/color.html)). When not explicitly set, but a
