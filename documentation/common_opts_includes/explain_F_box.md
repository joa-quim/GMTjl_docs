    ...
    - **fill=color**, where *color* is any valid color setting (see \[Setting color](../common_features/color.html), to fill the scale panel [no fill].
    ...
    - **pen=pen**, to specify different \[Pen attributes](../common_features/pens.html) attributes.
